...
module.exports = ({ strapi }) => ({
    ...
    delete: async (projectId) => {
        const deletedProjects = await strapi.entityService.delete("plugin::github-projects.project", projectId)
    ...
    deleteAll: async (projectIds) => {
        const deletePromises = projectIds.map(async (id) => await strapi.plugin("github-projects").service("projectService").delete(id))
